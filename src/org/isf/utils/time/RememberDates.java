...
public class RememberDates {
	...
	private static GregorianCalendar lastPatientPresentationDate = null;
...
//	}
	...
	public static GregorianCalendar getLastPatientPresentationDate() {
		GregorianCalendar gc = new GregorianCalendar();
		if (lastPatientPresentationDate != null) {
			gc.set(lastPatientPresentationDate.get(GregorianCalendar.YEAR),
				lastPatientPresentationDate.get(GregorianCalendar.MONTH),
				lastPatientPresentationDate.get(GregorianCalendar.DAY_OF_MONTH));
		}
		return gc;
	}

	public static void setLastPatientPresentationDate(GregorianCalendar labDate) {
		RememberDates.lastPatientPresentationDate = labDate;
	}
}
